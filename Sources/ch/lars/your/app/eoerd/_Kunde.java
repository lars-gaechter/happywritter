...
public abstract class _Kunde extends  ERXGenericRecord {
  ...
  // Relationship Keys
  public static final ERXKey<ch.lars.your.app.eoerd.Bestellung> BESTELLUNGS = new ERXKey<ch.lars.your.app.eoerd.Bestellung>("bestellungs", Type.ToManyRelationship);
  ...
  public NSArray<ch.lars.your.app.eoerd.Bestellung> bestellungs() {
    return (NSArray<ch.lars.your.app.eoerd.Bestellung>)storedValueForKey(_Kunde.BESTELLUNGS_KEY);
  }

  public NSArray<ch.lars.your.app.eoerd.Bestellung> bestellungs(EOQualifier qualifier) {
    return bestellungs(qualifier, null, false);
  }

  public NSArray<ch.lars.your.app.eoerd.Bestellung> bestellungs(EOQualifier qualifier, boolean fetch) {
    return bestellungs(qualifier, null, fetch);
  }

  public NSArray<ch.lars.your.app.eoerd.Bestellung> bestellungs(EOQualifier qualifier, NSArray<EOSortOrdering> sortOrderings, boolean fetch) {
    NSArray<ch.lars.your.app.eoerd.Bestellung> results;
    if (fetch) {
      EOQualifier fullQualifier;
      EOQualifier inverseQualifier = ERXQ.equals(ch.lars.your.app.eoerd.Bestellung.KUNDE_KEY, this);
      ...
      results = ch.lars.your.app.eoerd.Bestellung.fetchBestellungs(editingContext(), fullQualifier, sortOrderings);
    }
    else {
      results = bestellungs();
      if (qualifier != null) {
        results = (NSArray<ch.lars.your.app.eoerd.Bestellung>)EOQualifier.filteredArrayWithQualifier(results, qualifier);
      }
      if (sortOrderings != null) {
        results = (NSArray<ch.lars.your.app.eoerd.Bestellung>)EOSortOrdering.sortedArrayUsingKeyOrderArray(results, sortOrderings);
      }
    }
    return results;
  }

  public void addToBestellungs(ch.lars.your.app.eoerd.Bestellung object) {
    includeObjectIntoPropertyWithKey(object, _Kunde.BESTELLUNGS_KEY);
  }

  public void removeFromBestellungs(ch.lars.your.app.eoerd.Bestellung object) {
    excludeObjectFromPropertyWithKey(object, _Kunde.BESTELLUNGS_KEY);
  }

  public void addToBestellungsRelationship(ch.lars.your.app.eoerd.Bestellung object) {
  ...
  public void removeFromBestellungsRelationship(ch.lars.your.app.eoerd.Bestellung object) {
  ...
  public ch.lars.your.app.eoerd.Bestellung createBestellungsRelationship() {
    EOEnterpriseObject eo = EOUtilities.createAndInsertInstance(editingContext(),  ch.lars.your.app.eoerd.Bestellung.ENTITY_NAME );
    addObjectToBothSidesOfRelationshipWithKey(eo, _Kunde.BESTELLUNGS_KEY);
    return (ch.lars.your.app.eoerd.Bestellung) eo;
  }

  public void deleteBestellungsRelationship(ch.lars.your.app.eoerd.Bestellung object) {
    removeObjectFromBothSidesOfRelationshipWithKey(object, _Kunde.BESTELLUNGS_KEY);
    editingContext().deleteObject(object);
  }

  public void deleteAllBestellungsRelationships() {
    Enumeration<ch.lars.your.app.eoerd.Bestellung> objects = bestellungs().immutableClone().objectEnumerator();
  ...
  public static Kunde createKunde(EOEditingContext editingContext) {
