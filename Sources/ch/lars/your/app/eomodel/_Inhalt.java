...
public abstract class _Inhalt extends  ERXGenericRecord {
  ...
  // Relationship Keys
  public static final ERXKey<ch.lars.your.app.eomodel.Artikel> ARTIKELS = new ERXKey<ch.lars.your.app.eomodel.Artikel>("artikels", Type.ToManyRelationship);
  ...
  public NSArray<ch.lars.your.app.eomodel.Artikel> artikels(EOQualifier qualifier, NSArray<EOSortOrdering> sortOrderings) {
    NSArray<ch.lars.your.app.eomodel.Artikel> results;
      results = artikels();
      if (qualifier != null) {
        results = (NSArray<ch.lars.your.app.eomodel.Artikel>)EOQualifier.filteredArrayWithQualifier(results, qualifier);
      }
      if (sortOrderings != null) {
        results = (NSArray<ch.lars.your.app.eomodel.Artikel>)EOSortOrdering.sortedArrayUsingKeyOrderArray(results, sortOrderings);
      }
    return results;
  }
  ...
  public ch.lars.your.app.eomodel.Artikel createArtikelsRelationship() {
    EOEnterpriseObject eo = EOUtilities.createAndInsertInstance(editingContext(),  ch.lars.your.app.eomodel.Artikel.ENTITY_NAME );
  ...
  public NSArray<ch.lars.your.app.eomodel.BestellPosition> bestellPositions(EOQualifier qualifier, NSArray<EOSortOrdering> sortOrderings) {
