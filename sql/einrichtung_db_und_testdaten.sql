...
-- Exportiere Daten aus Tabelle newhappywritter.bestellposition: ~17 rows (ungefähr)
...
DROP TABLE IF EXISTS `bestelltekonfiguration`;
...
-- Exportiere Daten aus Tabelle newhappywritter.bestelltekonfiguration: ~1 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle newhappywritter.bestellung: ~63 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle newhappywritter.inhalt: ~37 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle newhappywritter.kunde: ~63 rows (ungefähr)
